 ...
 */
function orbisius_ct_elegantweb_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_elegantweb_parent_style';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_elegantweb_child_theme_enqueue_styles' );
